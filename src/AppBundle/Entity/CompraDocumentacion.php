...
/**
 * AppBundle\Entity\CompraDocumentacion
 *
 * @ORM\Table(name="compra_documentacion")
 * @ORM\Entity()
 * @ORM\HasLifecycleCallbacks
 */
class CompraDocumentacion {
    /**
     * @var integer $id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Compra",inversedBy="documentos" )
